...
local config = {
  ...
  mappings = {
    ...
    n = {
      ...
      ["<leader>of"] = { ":!start explorer %:h<CR>", desc = "打开当前文件的文件夹" },
      ...
      -- format
      ["<leader>f"] = { "<cmd>lua vim.lsp.buf.formatting()<CR>", desc = "格式化文档" },

      -- diagnostic
      ["g["] = { "<cmd>lua vim.diagnostic.goto_next()<CR>", desc = "下一个诊断" },
      ["g]"] = { "<cmd>lua vim.diagnostic.goto_prev()<CR>", desc = "上一个诊断" },
    ...
    v = {
      ...
      -- 格式化
      ["<leader>f"] = { "<cmd>lua vim.lsp.buf.formatting_sync()<CR>", desc = "格式化选定内容" },
    },
    t = {
  ...
  plugins = {
    init = {
      ...
      --   end,
      -- },
      { "chentoast/marks.nvim", require("marks").setup() },
